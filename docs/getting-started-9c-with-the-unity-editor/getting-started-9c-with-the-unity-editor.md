---
title: Playing the Nine Chronicles main network with the Unity editor
---
...
- Protected Private Key: An encrypted file of the private key.

1. Put your Protected Private Key into the Key Store path
...
2. (not recommended) Setting the private key directly in the clo.json file
